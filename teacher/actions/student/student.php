                        ...
                        <div class="card-header table-responsive">
                            <table class="table table-hover my-0">
                                <tr>
                                    ...
                                    <th class="  d-xl-table-cell">Profile</th>
                                </tr>
                                ...
                                <?php if(mysqli_num_rows($result) > 0): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="  d-xl-table-cell"><a href="<?=TEACHERURL.'/actions/student/profile.php?id='.$data['id']?>" class='btn btn-primary'>Details</a></td>
                                    </tr>
