...
if(isset($_POST['submit'])){
        ...
        $sql = "UPDATE students SET `name`=?, `email`=?, `role_id`=?, `class_id`=?, `password`=? WHERE id =?";
        ...
        <div class="card">
            <div class="card-body">
                <form action="" method="POST">
                    ...
                    <input type="submit" name="submit" value="Update Student Details" class="btn btn-primary mt-5">
                    <?php endforeach ?>
                </form>
            </div>
        </div>
